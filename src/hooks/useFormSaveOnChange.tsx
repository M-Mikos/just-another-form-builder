...
/**
 * This hook calls form's action on form change. Hook prevents from saving form on initial component render. Hook uses debouncing to reduce quantity of frequent action calls.
 *
 * @param formElement mutable form element stored in react useRef().
 * @param actionPath path to react router action function.
 */

const useFormSaveOnChange = (
  formElement: React.MutableRefObject<HTMLFormElement>,
  actionPath: string
) => {
